...
public class GetAllowanceImpl extends Service1 implements DialogInterface.OnClickListener{
				...
				@Override protected void onPostExecute(String s){
					...
					if (j.canRead()) {
						if (j.get("code", -1) == 0) {
							...
							//if (!signed.contains(uid))signed.add(uid);GetAllowance.this.log(string(name," 更新成功"));
