...
public abstract class SettingListControl implements View.OnClickListener{
	Activity Super;void tip(String s){Toast.makeText(Super,s,0).show();}
	SettingListControl This;
	ListView l; SimpleAdapter adapter;
	List<Map<String,Object>>list= new ArrayList<Map<String, Object>>();
	public SettingListControl(Activity Ts,ListView imp){
		l=imp; Super=Ts;This=this;
